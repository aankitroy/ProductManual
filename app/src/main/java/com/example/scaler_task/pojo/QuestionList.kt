...
object QuestionDemo {
    ...
    fun getQuestionList(): ArrayList<Question> {
        ...
        val question1 = Question().apply {
            ...
            answerSteps.add(AnswerStep(1,"Pull the back cover and remove it from the appliance.", R.drawable.mixer_grinder_step_1))
            answerSteps.add(AnswerStep(2,"Pull the filter from the appliance.", R.drawable.mixer_grinder_step_1))
            answerSteps.add(AnswerStep(3,"Remove all packaging materials of the air purification filter.", R.drawable.mixer_grinder_step_2))
            answerSteps.add(AnswerStep(4,"Put the filter back into the appliance.", R.drawable.mixer_grinder_step_1))
            answerSteps.add(AnswerStep(5,"Reattach the back cover.", R.drawable.mixer_grinder_step_1))
            lastScreenTitle = "Your Filter is now installed!"

        }
//        val questions1 = Question().apply {
//            question = "What is the Installation Process"
//            answer =
...
//        }
//
//        val questions10 = Question().apply {
...
//        }
//
//        val questions11 = Question().apply {
...
//        }
//        val questions12 = Question().apply {
...
//        }
//
//        val questions13 = Question().apply {
//            question = "वाई-फाई कनेक्शन कैसे स्थापित करें"
//            answer ="ऐप स्टोर या Google Play से Philips \"क्लीन होम\" ऐप डाउनलोड और इंस्टॉल करें।\n" +
//                    "2) एयर प्यूरीफायर का प्लग पावर सॉकेट में लगाएं और एयर प्यूरीफायर चालू करने के लिए टच करें। » वाई-फाई संकेतक पहली बार नारंगी को झपकाता है।\n" +
//                    "3) सुनिश्चित करें कि आपका स्मार्टफोन या टैबलेट आपके वाई-फाई नेटवर्क से सफलतापूर्वक जुड़ा है।\n" +
//                    "4) \"क्लीन होम\" ऐप लॉन्च करें और \"कनेक्ट ए न्यू डिवाइस\" पर क्लिक करें या स्क्रीन के शीर्ष पर \"\" बटन दबाएं। एआई को जोड़ने के लिए ऑन-स्क्रीन निर्देशों का पालन करें\n"
//        }
//        val questions14 = Question().apply {
...
//        }
//        val questions15 = Question().apply {
